...
enum Colors {
    ...
    static let cellRight                 = UIColor(named: "cellRight")
    static let cellLeft                  = UIColor(named: "cellLeft")
    static let bblue                     = UIColor(named: "bblueColor")
    static let blueBottom                = UIColor(named: "bblueColorBottom")
    static let yyellow                   = UIColor(named: "yellowColor")
    static let yellowBottom              = UIColor(named: "yellowColorBottom")
